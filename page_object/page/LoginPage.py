...
class LoginPage(BasePage):
    ...
    _register_phone=(By.ID,"register_phone_number")
    ...
    _bakc_locator=(By.XPATH,"//*[contains(@resource-id,'iv_close) or contains(@resource-id,'iv_action_back)")
    def loginByWX(self):
        return self
    ...
    def loginByPassword(self,account,password):
        ...
        return self
    def loginSuccessByassword(self,account,password):
